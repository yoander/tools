...
#LIST='resort-allinclusive.com vacation-allinclusive.com travel-allinclusive.com go2havana.us cubaparadisus.com go2varadero.ca cubasolmelia.ca'
...
for zone in $ZONES;do
	...
	# modify hosting
	sed -r -i 's/82.223.148.160/82.98.131.148/' $FILE && echo -e "--- Hosting has been changed\n" >> $LOG_FILE
